...
experiment("experimentControlled/01-RandomCapture.txt",[1.5,1.8],[-11,2])
experiment("experimentControlled/02-Bi-FrontCapture.txt",[0.08,0.3],[-2,11])
...
figure()
plotTable(home_500us, Info, tLim, yLim);
end
% 
