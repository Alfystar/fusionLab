...
\begin{multicols}{2}
	...
	\begin{spacing}{1.25}
		\begin{enumerate}[itemsep=-1mm]
			\item Pacchetti Self-Delimited
			\item Canale Multi-Packet ready
			\item Protocollo Senza Negoziazioni
			\item All’utilizzatore è richiesto solo diPre-Concordare il formato del pacchetto con l’altro lato dello stream
			\item Prerequisiti implementativi minimale (mezzo di comunicazione a bytes di tipo peer2peer asincrono)
		\end{enumerate}
	\end{spacing}
	\columnbreak
	\begin{center}
