...
% Packge per Box Colorati alle Equazioni
\usepackage{amsmath}
\usepackage{empheq}
...
\include{capitolo1-HW.tex}
\include{capitolo2-Architettura.tex}
\include{capitolo3-ModelloMatematico.tex}
\include{capitolo4-Controllo.tex}
