...
\begin{center}
	$ \lim\limits_{t \rightarrowtail \infty} e(t) =
...
$
\end{center}
Essendo $ \rho_{p} = -1 $ a causa dello Zero in 0, abbiamo che il controllore dovrà necessariamente avere $ \rho_{c} = 2 $ per ottenere $ \rho = 1 $
