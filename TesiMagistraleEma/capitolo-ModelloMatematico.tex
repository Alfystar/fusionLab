...
\begin{oss}
	...
	L'uso di un simile controllore, anche se permette un inseguimento a errore nullo, non rende il sistema \textbf{Input-to-state \underline{un}stabile} $ \Rightarrow $ il sistema è polinomialmente instabile.\\
